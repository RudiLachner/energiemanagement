...
// // Simulierte PV-Daten (initiale Werte)
// const pvData = [
...
//   // PV-Daten aktualisieren, wenn Änderungen in pv.js vorgenommen werden
//   window.addEventListener('pvDataUpdated', event => {
//     const updatedData = event.detail;
//     pvData.splice(0, pvData.length, ...updatedData);
